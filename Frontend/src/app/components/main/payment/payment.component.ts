...
//   const userKey = `savedCard_${this.userInfo.email}`;
//   const savedCard = JSON.parse(localStorage.getItem(userKey) || '{}');

//   if (savedCard.cardNumber) {
//     this.hasSavedCard = true;
//    this.savedCardNumberMasked =savedCard.savedCardNumberMasked;
...
//   if (this.useSavedCard && this.hasSavedCard) {
//     this.paymentData.cardHolderName = this.paymentData.cardHolderName;
//     this.paymentData.cardNumber = this.savedCardNumberMasked;
//     this.paymentData.expiryMonth = this.paymentData.expiryMonth;
//     this.paymentData.expiryYear = this.paymentData.expiryYear;
//     this.paymentData.cvv = ''; // never prefill CVV
//   } else {
//     this.paymentData = {
//       cardHolderName: '',
//       cardNumber: '',
...
//       "Debit Card": 1,
//     }
//     const rawCardNumber = this.useSavedCard ? '' : this.paymentData.cardNumber.replace(/\s/g, '');
...
//   localStorage.setItem(userKey, JSON.stringify(storedCard));
//   console.log("Card saved in localStorage for user:", userKey);
// }
